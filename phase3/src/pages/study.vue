    ...
    <div id="tabs" class="container">
      ...
      <div class="content">
        <div v-show="activetab === 1" class="tabcontent">
          <img
            :src="displayImages[0].contents"
            class="image_size contents_image"
          />
        </div>
        <div v-show="activetab === 2" class="tabcontent">
          <img
            :src="displayImages[1].contents"
            class="image_size contents_image"
          />
        </div>
        <div v-show="activetab === 3" class="tabcontent">
          <img
            :src="displayImages[2].contents"
            class="image_size contents_image"
          />
        </div>
        <div v-show="activetab === 4" class="tabcontent">
          <img
            :src="displayImages[3].contents"
            class="image_size contents_image"
          />
        </div>
        <div v-show="activetab === 5" class="tabcontent">
          <img
            :src="displayImages[4].contents"
            class="image_size contents_image"
          />
        </div>
      </div>
